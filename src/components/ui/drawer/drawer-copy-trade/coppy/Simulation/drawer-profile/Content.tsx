...
const ItemProfile = ({ label, value ,onClick}: any) => {
  return (
    <div className='flex flex-col gap-[2px]' onClick={onClick}>
      <Typography color={'#212121'} fontWeight={500} className='text-xs'>{value}</Typography>
      <Typography color={'#757575'} fontWeight={500} className='text-[10px] leading-3'>{label}</Typography>
...
const IconUser = () => {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M7.68123 1.33301C5.84028 1.33301 4.3479 2.82539 4.3479 4.66634C4.3479 6.50729 5.84028 7.99967 7.68123 7.99967C9.52218 7.99967 11.0146 6.50729 11.0146 4.66634C11.0146 2.82539 9.52218 1.33301 7.68123 1.33301Z" fill="white" />
      <path d="M7.68123 8.66634C8.35615 8.66634 9.00504 8.77778 9.6105 8.98325C9.4344 9.28111 9.33333 9.62859 9.33333 9.99967C8.22876 9.99967 7.33333 10.8951 7.33333 11.9997C7.33333 13.1042 8.22876 13.9997 9.33333 13.9997C9.33333 14.2334 9.37344 14.4578 9.44714 14.6663H4.3479C3.55175 14.6663 3.15368 14.6663 2.72598 14.3707C2.43644 14.1706 2.08409 13.6121 2.02814 13.2646C1.94548 12.7513 2.05125 12.5296 2.2628 12.0861C3.22756 10.0638 5.2912 8.66634 7.68123 8.66634Z" fill="white" />
      <path d="M10.6667 9.99967C10.6667 9.63148 10.9651 9.33301 11.3333 9.33301C11.7015 9.33301 12 9.63148 12 9.99967V11.333H13.3333C13.7015 11.333 14 11.6315 14 11.9997C14 12.3679 13.7015 12.6663 13.3333 12.6663H12V13.9997C12 14.3679 11.7015 14.6663 11.3333 14.6663C10.9651 14.6663 10.6667 14.3679 10.6667 13.9997V12.6663H9.33333C8.96514 12.6663 8.66667 12.3679 8.66667 11.9997C8.66667 11.6315 8.96514 11.333 9.33333 11.333H10.6667V9.99967Z" fill="white" />
    </svg>
