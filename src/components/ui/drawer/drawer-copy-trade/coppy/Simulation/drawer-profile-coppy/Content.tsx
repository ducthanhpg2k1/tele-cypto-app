    ...
    <div className='flex flex-col gap-4'>
      <div className='flex flex-col gap-1'>
        <div className='flex justify-between'>
          ...
          <div className='border-2 max-h-5 border-[#EEEEEE] rounded py-0.5 px-1 flex items-center gap-1'>
            <IconStar />
            <Typography color={'#757575'} fontWeight={400} className='text-[10px] leading-3'>
              110
            </Typography>
          </div>
        </div>
        <div className='flex flex-col gap-0.5'>
          <div className='flex items-center gap-1'>
            ...
            <div className='bg-[#F5F5F5] rounded py-0.5 px-1 flex items-center gap-0.5 w-max'>
              ...
              <Typography color={'#212121'} fontWeight={500} className='text-[10px] leading-3'>
                {t('copyTrade.private')}
              </Typography>
            </div>
          </div>
      ...
      <div className='mt-4 flex flex-col gap-4'>
        <div className='flex justify-between items-center'>
          ...
          <div className='flex items-center gap-0.5'>
            <Typography className='text-[12px] leading-[18px]'  color={'#212121'} fontWeight={500}>
              30 Ngày
            </Typography>
      ...
      <div className='flex items-center gap-3 mt-4 sticky bottom-0'>
        <Button fullWidth variant='blue' className='h-9 font-semibold'>
          <Typography className='text-[12px]'>{t('copyTrade.filter.simulationBtn')}</Typography>
        </Button>
        <Button fullWidth className='h-9 font-semibold'>
          <Typography className='text-[12px]'>{t('copyTrade.filter.copyBtn')}</Typography>
        </Button>
      </div>
    </div>
  );
