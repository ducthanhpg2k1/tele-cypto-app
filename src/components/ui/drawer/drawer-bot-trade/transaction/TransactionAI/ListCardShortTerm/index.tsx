                    ...
                    return (
                        <Card key={item?.id} sx={{
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Button>
                                    <Typography fontWeight={700} className="text-[12px]">Sao chép</Typography>
                                </Button>
                            </div>
                            ...
                            <Typography color={'#177DFF'} fontWeight={500} className="text-xs">Tuỳ chỉnh thông số</Typography>
...
const ItemCard = ({ label, value }: { label: string, value: string }) => {
    return (
        <div className="flex justify-between items-center">
            <Typography color={'#9E9E9E'} fontWeight={400} className="text-xs">{label}</Typography>
