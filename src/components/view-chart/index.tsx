...
const ViewChart = () => {
  ...
  return (
    <div className='flex flex-col pb-6'>
      ...
      {value === TYPE_TAB.CHART_LINE && <ChartLine />}

      {value === TYPE_TAB.CHART_PIE && <ChartPie />}
